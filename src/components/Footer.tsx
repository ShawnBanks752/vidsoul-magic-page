    ...
    <footer className="bg-white pt-20 pb-12">
      <div className="container-custom">
        ...
        <div className="relative mb-20">
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 opacity-10 blur-lg"></div>
          <div className="relative glass-effect rounded-2xl p-12 overflow-hidden">
            <div className="absolute top-0 right-0 -mt-10 -mr-10 w-80 h-80 bg-blue-100 rounded-full opacity-20"></div>
            <div className="absolute bottom-0 left-0 -mb-10 -ml-10 w-60 h-60 bg-indigo-100 rounded-full opacity-20"></div>
            
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between">
              <div className="mb-8 lg:mb-0 text-center lg:text-left">
                <h3 className="text-2xl lg:text-3xl font-bold mb-3">Ready to transform your video creation?</h3>
                <p className="text-gray-600 lg:text-lg">Start creating professional videos with AI today.</p>
              </div>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button className="button-gradient text-white rounded-full px-8 py-6">
                  Get Started Free
                </Button>
                <Button variant="outline" className="rounded-full px-8 py-6 border-gray-300">
                  Request Demo
                </Button>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Transform your ideas into high-quality videos with our AI-powered platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Use Cases</a></li>
        ...
        <div className="pt-8 border-t border-gray-200 text-center">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} VidSoul AI. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
